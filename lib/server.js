 ...
 */
function serverSession(sock, options, handleCmd) {
...
function server(options, handleCmd, callback) {
	...
	tlsOrNet.createServer(options, function(sock) {
		var returnObj = serverSession(sock, options, handleCmd);
